...
import type { KnowledgeText, KnowledgeTextInsert, KnowledgeTextUpdate } from '@shared/types/knowledge'

// Re-export types for convenience
export type { KnowledgeText, KnowledgeTextInsert, KnowledgeTextUpdate }
